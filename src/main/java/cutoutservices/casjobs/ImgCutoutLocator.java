...
public class ImgCutoutLocator extends org.apache.axis.client.Service implements cutoutservices.casjobs.ImgCutout {
    ...
    public cutoutservices.casjobs.ImgCutoutSoap_PortType getImgCutoutSoap() throws javax.xml.rpc.ServiceException {
    ...
    public cutoutservices.casjobs.ImgCutoutSoap_PortType getImgCutoutSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cutoutservices.casjobs.ImgCutoutSoap_BindingStub _stub = new cutoutservices.casjobs.ImgCutoutSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cutoutservices.casjobs.ImgCutoutSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cutoutservices.casjobs.ImgCutoutSoap_BindingStub _stub = new cutoutservices.casjobs.ImgCutoutSoap_BindingStub(new java.net.URL(ImgCutoutSoap_address), this);
                _stub.setPortName(getImgCutoutSoapWSDDServiceName());
                return _stub;
            }
        } catch (Throwable t) {
