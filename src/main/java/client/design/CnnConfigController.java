...
import client.design.canvas.CanvasGroup;
import client.design.canvas.SceneGestures;
...
public class CnnConfigController implements Initializable {
    private static final DataFormat SERIALIZED_MIME_TYPE = new DataFormat("application/x-java-serialized-object");
    private static final Logger logger = LogManager.getLogger(CnnConfigController.class);
