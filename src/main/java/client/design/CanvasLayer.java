...
import model.convnet.ConvolutionalLayer;
import model.convnet.Layer;
import model.convnet.Neuron;
...
public class CanvasLayer extends VBox implements Initializable {
    private static final Logger logger = LogManager.getLogger(CanvasLayer.class);
    ...
    private void setupBox() {
        ...
        layerBox.setOnMouseExited(me -> {
            ...
            material1.setSpecularPower(5.0);
            layerBox.setMaterial(material11);
            logger.trace(Platform.isSupported(ConditionalFeature.SCENE3D));
